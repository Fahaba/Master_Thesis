...
\begin{figure}[h!]
	\lstinputlisting[frame=none, language=C, firstline=23, lastline=26, firstnumber=23 ]{../../Master\_parallel\_fourier\_audio/StreamWriter/WAV.c}
...
Der untere Graph zeigt auch unter anderem die erstellte Testdatei, in der zwei harmonische Sinuswellen (300hz und 40hz) auf jeweils dem linken bzw. rechten Audiokanal überlagert sind.
...
\begin{figure}[h!]
	\lstinputlisting[frame=none, language=C, firstline=301, lastline=305, firstnumber=301 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=307, lastline=307, firstnumber=307 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=309, lastline=310, firstnumber=309 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=313, lastline=326, firstnumber=313 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
...
\begin{figure}[h!]
	\lstinputlisting[frame=none, language=C, firstline=271, lastline=274, firstnumber=271 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=276, lastline=283, firstnumber=276 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=285, lastline=286, firstnumber=285 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=288, lastline=289, firstnumber=288 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=292, lastline=296, firstnumber=292 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
...
\begin{figure}[t!]
	\lstinputlisting[frame=none, language=C, firstline=337, lastline=338, firstnumber=337 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=340, lastline=344, firstnumber=340 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=347, lastline=349, firstnumber=347 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	...
	\lstinputlisting[frame=none, language=C, firstline=362, lastline=362, firstnumber=362 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=372, lastline=376, firstnumber=370 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=379, lastline=383, firstnumber=378 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
...
\begin{figure}[h!]
	\lstinputlisting[frame=none, language=C, firstline=129, lastline=130, firstnumber=129 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\lstinputlisting[frame=none, language=C, firstline=132, lastline=133, firstnumber=132 ]{../../Master\_parallel\_fourier\_audio/Master\_parallel\_fourier\_audio/kernel.cu}
	\caption{CUDA Kernel}
...
Der weitere Ablauf des Python Moduls verläuft analog zum C-Äquivalent. Nach der erfolgreichen Abschluss der FFT und dem Warten auf Beendigung aller CUDA Threads, werden die Daten zum Bokeh Server gesendet. Anschließend werden neue Daten am TCP-Socket des StreamWriter-Moduls erwartet.
